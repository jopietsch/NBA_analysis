...
on and dumped to docs/player_ranking_overview_guards.json by the pipeline. This
...
from player_ranking_overview_facts import load_guards

GUARDS_PATH = os.path.join(
    os.path.dirname(os.path.dirname(__file__)), "docs", "player_ranking_overview_guards.json"
)
