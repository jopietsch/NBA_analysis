...
**They disagree in the middle.** Win Shares favors efficient big men on good teams (Domantas Sabonis, Ivica Zubac), while PER rewards high-usage scorers (Zion Williamson, Kristaps Porziņģis), so the same player can sit many spots apart in the two. The plus/minus systems, sensitive to steals, can rate a high-steal defender near the top while the rate metrics place him mid-pack. The systems genuinely see different things outside the very top tier.
