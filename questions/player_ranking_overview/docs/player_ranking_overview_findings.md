...
See `../generated/images/rank_agreement_heatmap.svg` for the full correlation matrix.
...
See `../generated/images/system_outliers.svg`.
...
The scatter plot at `../generated/images/uber_rating_comparison.svg` shows where the two approaches agree and where they diverge.
...
The rank-value chart at `../generated/images/ordinal_vs_value_gap.svg` makes this concrete. The visual gap between rank 1 and rank 10 looks like 10 spots on a list. The numerical gap is often several times larger than the gap between rank 10 and rank 50.
