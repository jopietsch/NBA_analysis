...
PER, the oldest and simplest box score, rebuilds about 64% of the gaps between teams in the season just played, more than the plus/minus metrics built to track exactly that, yet it forecasts the next season at only about 25%.
