...
A reconstruction bug once made that independence look like noise; with it fixed, the prior-informed RAPM+prior is a usable impact metric, led by the MVP tier (Shai Gilgeous-Alexander, Giannis Antetokounmpo, Nikola Jokić) and as steady from year to year as BPM.
