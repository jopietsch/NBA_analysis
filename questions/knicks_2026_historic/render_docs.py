...
Every number cited in the prose comes from a fact (``docs/knicks_2026_historic_facts.json``)
...
- ``--reference`` write ``docs/knicks_2026_historic_facts_reference.md``: every fact in a table.
