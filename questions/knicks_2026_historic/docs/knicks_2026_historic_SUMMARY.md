...
![Per-round raw margins vs. opponent-adjusted margins using each opponent's playoff form against other teams. The Finals adjustment is large because the Spurs elevated dramatically through the West bracket.](../generated/knicks_2026_round_split.png){width=100%}
