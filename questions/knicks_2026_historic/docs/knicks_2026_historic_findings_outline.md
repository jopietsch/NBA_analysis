...
- Full details in RESULTS.md and knicks_2026_analysis.py.
...
|-----|------------------|-------------|-------------------|---------------------|
| K01 | §1 L7  | 16-3, 88th pct win rate | §1 THE RAW CLAIM | win rate 0.842; 88.4th pct; mean 0.752 |
| K02 | §1 L8  | +14.9 pts/game raw margin, highest ever | §1 THE RAW CLAIM | +14.89 pts/game, 100th pct |
| K03 | §1 L10 | CI [+7.4, +22.4] | §1 THE RAW CLAIM | 95% CI [+7.4, +22.4] (t-interval, 19 games) |
...
| K11 | §3 L80 | most West-dominant: 2013-14 +4.08 | §3 HOW WEAK IS THE EAST | top 3: 13-14 +4.08, 03-04 +3.73, 00-01 +3.11 |
| K12 | §3 L85 | opp SRS +3.67, 49th pct | §4 WHO DID THE KNICKS BEAT | games-wtd opp SRS +3.67, 48.8th pct |
| K13 | §4 L111 | Warriors adj +10.2 (2nd) | §5 OPPONENT-ADJUSTED (top 5) | 16-17: adj +10.23 |
| K14 | §4 L121 | overperformance +12.5 pts/game, 2nd all-time | §5 OPPONENT-ADJUSTED (overperf) | +12.52 pts/game, 97.7th pct |
| K15 | §4 L123 | elevation +11.48, 2nd all-time | §8 PLAYOFF SRS AND ELEVATION | elev +11.48, 97.7th pct; best 2000-01 +12.58 |
| K16 | §5 L162 | playoff-SRS-adj margin +9.1 pts/game, best | §6 ROUND-BY-ROUND (full-run po-SRS adj) | +9.05 pts/game, 100th pct; 86-87 +8.99 |
| K17 | §5 L157 | Spurs reg +8.28, playoff +14.5, +6.2 jump | §6 ROUND-BY-ROUND (opp SRS table) | Spurs PO SRS +14.48, gap +6.20 |
| K18 | §6 L176 | Knicks elevation +11.48, largest in 2026 field | §6 ROUND-BY-ROUND (field elevation) | Knicks +11.48, Spurs +6.85, Blazers +3.01 |
| K19 | §6 L181 | Spurs climbed to playoff SRS +15.13, rise +6.85 | §6 ROUND-BY-ROUND (field elevation) | Spurs reg +8.28, PO +15.13, elev +6.85 |
| K20 | §6 L195 | OKC led regular season (+11.04), barely changed (+0.38) | §6 ROUND-BY-ROUND (field elevation) | OKC reg +11.04, PO +11.42, elev +0.38 |
| K21 | §7 L210 | 31.6% games decided by <=5 pts, 83.7th pct | §7 OTHER DEFLATORS | 0.316; 83.7th pct; mean 0.256 |
| K22 | §7 L215 | home win rate 77.8%, 23rd pct | §7 OTHER DEFLATORS | home 9G, 0.778, 23.3th pct |
| K23 | §7 L217 | away win rate 90.0%, 98th pct | §7 OTHER DEFLATORS | away 10G, 0.900, 97.7th pct |
| K24 | §8 L230 | beat spread by avg +16.9 pts/game | §12 BETTING-MARKET | avg ATS margin +16.9; ATS record 16-3 |
| K25 | §8 L239 | 14-0 ATS vs. East opponents | §12 BETTING-MARKET (round-by-round ATS) | R1 6/6, R2 4/4, CF 4/4 = 14-0 |
| K26 | §8 L240 | Finals dead-on: 2-5 ATS | §12 BETTING-MARKET (round-by-round ATS) | Finals 2/5; avg margin +2.4 vs. spread +2.5 |
| K27 | §9 L281 | avg opponent health 98% | §11 OPPONENT PLAYER AVAILABILITY | avg 98%; Spurs 100% |
| K28 | §9 L283 | close Finals margin +2.4 reflects real competition | §11 OPPONENT PLAYER AVAILABILITY | Spurs 100% health confirmed |
| K29 | §10 L297 | #1 in 60% of bootstrap re-runs | §13 ROBUSTNESS (bootstrap rank) | P(rank #1) = 59.6% |
| K30 | §10 L297 | top 3 in 70% | §13 ROBUSTNESS | P(top 3) = 69.9% |
| K31 | §10 L298 | top 5 in 82% | §13 ROBUSTNESS | P(top 5) = 82.4% |
| K32 | §10 L300 | adj margin range [+5.1, +17.7] | §13 ROBUSTNESS | 90% interval [+5.08, +17.71] |
| K33 | §10 L307 | shrunken margin +6.5/game | §13 ROBUSTNESS (EB shrinkage) | posterior +6.50; 95% CI [+1.53, +11.48] |
| K34 | §10 L307 | shrinkage range [+1.5, +11.5] | §13 ROBUSTNESS | 95% credible interval [+1.53, +11.48] |
| K35 | §10 L328 | hierarchical: Knicks true #1 only ~9% | §14 HIERARCHICAL | P(true #1) = 9.0%; posterior mean +4.70 |
| K36 | §10 L336 | hierarchical pulls from +11.2 down to ~+4.7 | §14 HIERARCHICAL | Knicks posterior +4.70; 90% CI [+1.80, +7.60] |
| K37 | §11 L361 | wins-only (BT): Knicks #1 of 43 | §16 WINS-ONLY (BRADLEY-TERRY) | BT adj +11.37, rank #1; corr with SRS +0.990 |
| K38 | §11 L371 | Elo-adjusted margin +9.4/game, 3rd | §15 ELO CROSS-CHECK | Elo adj +9.36, rank #3; opp rating +5.53 |
| K39 | §12 L394 | model gave Knicks only 15% title probability | §18 SERIES-LEVEL WIN-PROBABILITY | P(title) = 14.7% |
| K40 | §12 L396 | only 7% of model championship runs that clean | §18 SERIES-LEVEL WIN-PROBABILITY | P(title run <=3 losses) = 6.7% |
| K41 | §12 L397 | barely 1% produced title AND <=3 losses | §18 SERIES-LEVEL WIN-PROBABILITY | P(title AND <=3 losses) = 1.0% |
| K42 | §1 L13  | possessions only ~4% above average | §17 POSSESSIONS-BASED PACE | 2025-26 pace 101.8 vs. mean 98.0 = +3.8/game (~4%) |
