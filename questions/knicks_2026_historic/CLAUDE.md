...
- `docs/knicks_2026_historic_summary.md` — standalone one-page summary built around three core charts (adjusted margin ranking, round split, title-run rarity) and the main question.
...
- `docs/knicks_2026_historic_eras.md` — standalone one-page field guide to comparing teams across eras (the project's second goal): the two axes (opponent rating, era normalization), each technique, and what it produces, with the Knicks as the worked example. Templated from facts; regenerate with `python3 ../generate_doc_pdf.py docs/knicks_2026_historic_eras.md`.
