...
![Fig X — Bayesian change-point model (k=0/1/2/3 fitted lines; posterior distribution over break year for k=1)](../generated/nba_home_court_bayesian_changepoint.png)
