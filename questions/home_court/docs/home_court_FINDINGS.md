...
![Why the home rebounding advantage faded. Left: home and away OREB rates (% of available offensive boards) over time — both fell as the league abandoned crashing the glass, but the home rate dropped 8 pp (34% → 26%) while the away rate dropped only 5 (31% → 26%), causing the lines to converge and cross. Right: the home rebound-share edge fades in lockstep with the league-wide retreat from offensive rebounding (r = 0.82).](../generated/nba_home_court_rebounding.png)
