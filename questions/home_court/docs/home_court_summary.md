...
The right panel shows where the decline has registered. Rebounding carries the largest share at roughly **30%**, followed by turnovers at about **27%**. Together they account for more than half the drop. Shooting accounts for about **21%** and the narrowing foul gap for about **18%**. For fouls and turnovers, threee-point attempt is a major reason that they declined: as three-point attempts rose, the foul and turnover gaps each shrank by about half. Rebounding tells a different story: it is the largest single driver of the decline, and it barely moves with three-point volume.
