...
![Left: home win % by rest situation. Right: altitude franchises (Denver and Utah) vs. league average, regular season and playoffs.](../generated/nba_home_court_rest_altitude.svg){#fig-rest-altitude}
...
![Left: visitor back-to-back frequency over time (the premise is correct). Right: shift-share decomposition showing 8% from schedule change, 92% from within-situation erosion.](../generated/nba_home_court_back_to_back.svg){#fig-back-to-back}
...
![Pace vs. home win % over time, regular season and playoffs.](../generated/nba_home_court_pace.svg){#fig-pace}
...
![Competitive balance vs. home win % per season, regular season.](../generated/nba_home_court_parity.svg){#fig-parity}
...
![Left: league average attendance vs. regular-season home win %, 2000–2026. Right: 2020–21 home win % by game attendance.](../generated/nba_home_court_attendance.svg){#fig-attendance}
