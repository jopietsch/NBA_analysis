...
Today the weaker team hosting wins about 49%, while the stronger team's home rate fell only modestly on net, from around 70–75% at its peak to about 65%.
...
Prefer it in pieces?
This report is also available as a [series of shorter articles](home_court_series.html).
...
The timing even lines up with the second steepening, when the three-point share rose from about a quarter to 40% of all shots in the seasons after 2017.
...
| [Article Series](home_court_series.html) | This report recut as eight standalone articles, each a shorter read on one part of the story. |
...
| Article Series | web only | This report recut as eight standalone articles; the series lives on the site, not in the PDF set. |
