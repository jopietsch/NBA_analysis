...
**Why this matters.** Teams play 82 games to earn the right to host in the players, and that right used to be an important rewardfat: in the 1980s and 1990s, a weaker team in the playoffs playing at home won 65% and 66% of those games, nearly the same rate as the stronger team at its own arena. The building equalized the quality gap. Today the weaker team hosting wins about 49%, while the stronger team's home rate has barely moved. **Home court used to compensate for being outmatched.** It no longer does. The decline also shows four real changes in the game as mentioned above, and it's always intersting to pay attention to shifts and changes.

**What is NOT** behind it is also interesting: **rule changes, travel, time zones, pace of play, crowd size, and the playoff format changes, including the much-blamed 2014 change.** Each one is tested here and ruled out. 

Throughout, the regular season and the playoffs are tracked separately. They share a similar shapen and pattern, but the playoffs are behind the regular season in this decline. The analysis covers almost 52,000 regular-season and playoff games; see Appendix A for companion documents including the full statistical tables, and Appendix C for additional findings.
