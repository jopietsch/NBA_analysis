...
**Why this matters.** Teams play 82 games to earn the right to host, and that right used to mean something specific in the playoffs: in the 1980s and 1990s, a weaker team playing at home won 65% and 61% of those games, nearly the same rate as the stronger team at its own arena. The building equalized the quality gap. Today the weaker team hosting wins about 47%, while the stronger team's home rate has barely moved. Home court used to compensate for being outmatched. It no longer does. The decline also shows four real changes in the game: officiating grew more even, the leaguewide move to the three-point line flattened the shooting edge, teams retreated from the offensive glass, and the turnover edge between home and road teams closed. 
