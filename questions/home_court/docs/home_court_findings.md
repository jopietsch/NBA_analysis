...
The brief uptick visible around 2002-04 is real but not formally established: comparing eras shows a +1.2 percentage-point gain over 1995-01, but only three seasons are available, too few to be statistically reliable (p=0.23). Zone defense was legalized starting in 2001-02. One plausible explanation is that the new defensive complexity initially benefited home teams, who could practice and adapt in a familiar setting while visiting teams adjusted more slowly. That is a hypothesis the data is consistent with, not a conclusion it supports.

This doesn't contradict the frequentist QLR result: the QLR finds the one year a single break fits best (1999), while the Bayesian comparison asks how many breaks the series needs. The data still show no sudden break anywhere across the full window, consistent with each change being a gradual bend in the slope rather than an abrupt jump. Three-point attempt rate also does not predict next season's home win rate, and year to year, neither series leads the other in time.
