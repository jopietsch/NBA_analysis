...
![Bayesian change-point model for the 40-year HCA decline. Left: season-level home win % with fitted lines for each model (k=0 grey dashed, k=1 blue solid, k=2 red dash-dot, k=3 green dotted); MAP break years labeled for each multi-break model; slope estimates for the k=1 model shown bottom-left. Right: posterior distribution over break year for k=1; the MAP at 1999 concentrates about half the probability, with the 95% HPD spanning 1992–2003.](../generated/nba_home_court_bayesian_changepoint.png)
