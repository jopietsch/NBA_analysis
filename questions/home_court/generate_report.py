...
if __name__ == "__main__":
    build_report(ReportConfig(
        ...
        appendix_desc=(
            "Auto-generated by nba_home_court_analysis.py each time the analysis is run. "
            "Contains the sequential R² decomposition, pre/post-2014 coefficient stability "
            "check, bivariate factor significance table, and foul/shooting differential "
            "trends by era."
        ),
