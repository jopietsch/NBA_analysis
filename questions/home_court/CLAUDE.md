...
- `docs/home_court_summary.md` — standalone one-page summary built around the three core charts (the decline `nba_home_court_advantage_season.svg`, the box-score mediation `nba_home_court_mediation.svg`, the rebounding collapse `nba_home_court_rebounding.svg`) and the three questions; has a generated PDF (`generated/home_court_summary.pdf`).
