...
- **`generate_results_pdf.py`** — renders `docs/RESULTS.md` as a standalone PDF + HTML (`generated/home_court_results.pdf`); run after any pipeline run that refreshes `RESULTS.md`
