...
![Figure 3. Home team win margin trends — mean margin per season and by era (regular season and playoffs), with the win-only vs. loss-only split for the regular season.](nba_home_court_margin.png)
