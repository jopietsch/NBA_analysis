...
Home court advantage in the NBA has been declining for four decades. This report traces the full arc — from its peak in the mid-1980s through today — across 51,000 regular-season and playoff games. The underlying regression tables are in `RESULTS.md`.
...
![Figure 1. Regular season vs. playoff home win % over time, 1983–84 through 2024–25.](nba_home_court_advantage.png)

---

## 2. How the Drop Unfolded

The regular-season decline came in two waves. The first hit with the rule changes of the mid-1990s — home win % fell from 65% to 60% in a single era transition, the sharpest single drop in the dataset. It then stabilized for the better part of two decades before a second drop, arriving after 2017, pushed it below 56%.
...
**Shooting edge.** Home teams have consistently shot the ball better than road teams — roughly 1.5 percentage points better in field goal percentage across the full period, with a similar gap in effective field goal percentage. Part of this reflects psychological comfort, part reflects familiarity with the floor and backdrop of a specific arena. The effect has been consistent across eras in both regular season and playoffs.
...
**Competitive balance.** A widely cited argument holds that more parity compresses game outcomes toward 50-50, reducing home court advantage. The numbers do not support this. The spread in team win percentages across the league has no consistent relationship to home win rates. Some of the most unequal eras (1995–01) had already seen HCA fall sharply; some of the most balanced (2002–04) saw it tick back up. The two series don't move together.
...
What hasn't driven the decline: travel distance, time zones, pace of play, competitive balance, and playoff scheduling format. The data rules each of them out.
